...
## #componentes
Arduino Uno R3, sensor de umidade de solo analógico conectado ao pino **A0**, LED vermelho no pino **12** (solo seco), LED verde no pino **13** (solo úmido), dois resistores para proteção dos LEDs, protoboard e jumpers.
